<nav x-data="{ open: false }" class="bg-primary-light dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('index') }}">
                        <img class="w-[100px] h-[100px] mt-2" src="{{ asset('images/Logo_toko-trans.png') }}"
